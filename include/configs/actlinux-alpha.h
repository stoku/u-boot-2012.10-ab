/*
 * Configuration settings for Act Brain actlinux-alpha board
 *
...
#ifndef __ACTLINUX_ALPHA_H
#define __ACTLINUX_ALPHA_H
...
#define CONFIG_SYS_CLK_FREQ	50000000 /* 50.00 MHz */
#else
#define CONFIG_SYS_CLK_FREQ	44444444 /* 44.44 MHz */
...
/* Board name */
#define CONFIG_ACTLINUX_ALPHA	1
...
/* Enable the PHY driver */
#define CONFIG_PHYLIB

/* Enable the Micrel PHY driver */
#define CONFIG_PHY_MICREL		1

/* Enable the miiphybb driver */
...
/* Define the numbfer of ports to be used */
...
/* Define the RMII/MII/GMII mode (RMII_MII register) */
